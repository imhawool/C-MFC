...
CUpdaterDlg::CUpdaterDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CUpdaterDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CUpdaterDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_SETUPDATEEVENT, &CUpdaterDlg::OnBnClickedButtonSetupdateevent)
END_MESSAGE_MAP()
...
void CUpdaterDlg::OnBnClickedButtonSetupdateevent()
{
	...
	CEvent UpdateEvent(FALSE, TRUE, _T("UPDATE_TEST_EVENT"));
