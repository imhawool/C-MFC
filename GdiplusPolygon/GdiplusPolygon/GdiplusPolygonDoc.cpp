...
// 축소판 그림을 지원합니다.
void CGdiplusPolygonDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CGdiplusPolygonDoc::InitializeSearchContent()
{
...
void CGdiplusPolygonDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
