...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	ON_WM_CREATE()
	ON_WM_SETFOCUS()
	ON_COMMAND(ID_MENU_CREATETHREAD, &CMainFrame::OnMenuCreatethread)
	ON_COMMAND(ID_MENU__RESUMETHREAD, &CMainFrame::OnMenuResumethread)
...
void CMainFrame::OnMenuCreatethread()
{
