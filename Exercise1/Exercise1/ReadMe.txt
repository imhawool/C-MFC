...
응용 프로그램 마법사에서 이 Exercise1 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 Exercise1 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
Exercise1.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CExercise1App 응용 프로그램
    클래스를 선언합니다.

Exercise1.cpp
    응용 프로그램 클래스 CExercise1App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\Exercise1.ico
    ...
    주 리소스 파일인 Exercise1.rc에 의해 포함됩니다.
...
res\Toolbar.bmp
 ...
 리소스 편집기를 사용하여 이 도구 모음 비트맵을 편집하고
    Exercise1.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
Exercise1Doc.h, Exercise1Doc.cpp - 문서
    이 파일에는 CExercise1Doc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CExercise1Doc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

Exercise1View.h, Exercise1View.cpp - 문서 뷰
    이 파일에는 CExercise1View 클래스가 들어 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 Exercise1.pch와
