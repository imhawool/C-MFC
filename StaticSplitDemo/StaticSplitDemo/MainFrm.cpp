...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	if (!m_wndSplitVer.CreateStatic(&m_wndSplitHor,2,1, WS_CHILD | WS_VISIBLE, m_wndSplitHor.IdFromRowCol(0,1)))
	{
		return FALSE;
	}
	if (!m_wndSplitVer.CreateView(0,0,RUNTIME_CLASS(CTopHtmlView),CSize(100,300),pContext))
	{
		return FALSE;
	}
