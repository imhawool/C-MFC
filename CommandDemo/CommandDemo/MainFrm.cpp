...
void CMainFrame::OnMenuStart()
{
	...
	m_bRunning = TRUE;
	AfxMessageBox(_T("시작메뉴를 선택하였습니다."));
}
...
void CMainFrame::OnMenuStop()
{
	...
	AfxMessageBox(_T("종료메뉴를 선택하였습니다."));
}
...
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	//if(m_bPause) pCmdUI->SetText(_T("다시시작"));
	//else		 pCmdUI->SetText(_T("일시정지"));
...
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	AfxMessageBox(_T("서브메뉴를 선택하였습니다."));
}
