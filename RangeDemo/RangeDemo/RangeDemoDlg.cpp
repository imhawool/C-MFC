...
CRangeDemoDlg::CRangeDemoDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CRangeDemoDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CRangeDemoDlg, CDialogEx)
	...
	ON_WM_MOUSEMOVE()
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER, &CRangeDemoDlg::OnNMCustomdrawSlider)
END_MESSAGE_MAP()
...
void CRangeDemoDlg::OnMouseMove(UINT nFlags, CPoint point)
{
...
void CRangeDemoDlg::OnNMCustomdrawSlider(NMHDR *pNMHDR, LRESULT *pResult)
{
