...
// 축소판 그림을 지원합니다.
void CDynSplitDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CDynSplitDemoDoc::InitializeSearchContent()
{
...
void CDynSplitDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
