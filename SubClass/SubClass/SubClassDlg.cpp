...
// SubClassDlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "SubClass.h"
#include "SubClassDlg.h"
...
CSubClassDlg::CSubClassDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CSubClassDlg::IDD, pParent)
{
...
void CSubClassDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CSubClassDlg::OnQueryDragIcon()
{
